  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email && password) {
        ...
        navigate(mockUser.role === 'admin' ? '/portal/admin' : '/portal/client');
      }
    } catch (error) {
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
